...
$A_t = \left( \sum\frac{N_t}{N_{t=5}\cdot t}\right)\cdot 100$ and $S_{t}=\left(\frac{\sum_{t=5}^T{y_t}}{t}\right)\cdot 100$

where $t\geq5$ and $T$ the total number of time steps for the game session.
