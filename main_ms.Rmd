...
We chose to focus on a scenario that systematically varies one focal parameter, farmer land ownership distribution.
...
On starting a new session, the player is presented with one of three possible scenarios: equal land ownership, moderate variability, or high variability (`ownership_var` = 0, 0.25 or 0.5, respectively, resulting landscape patterns illustrated in **Fig X**).
...
We circulated a link to the game with scenarios configured as above to a sample of XXX collegues working in conservation science and practical conservation and management, covering a range of academic institutions, research institutes, NGO's and government.
