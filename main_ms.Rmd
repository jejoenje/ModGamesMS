...
Games have a long history of use in research [@sandbrook2015; @chabris2017; @redpath2018], including as tools to aid the communication of complex ideas and processes to non-specialists [@garcia2016; @tan2018; @fjaellingsdal2019], with online and video games recently becoming popular (**REF**).
...
The users (farmers) may allocate their budget to taking one of several potential actions (here: hunting animals, scaring animals off their land, or tending crops - they may only take these actions on their own land).
Note that "scaring", i.e. deterring animals from causing damage to crops, for example through the use of acoustic deterrents, is common in the management and control of grazing animals on croplands (e.g. geese, **REF**).
