...
<!--# Add section describing core (default) parameter settings, i.e. number/type of available actions -->
...
<!--# Does this need to be here or in the next section? -->
...
$A_t = \frac{\sum_{t=5}^n{\frac{N_t}{N_{t=5}}}}{t}$ and $S_t=\frac{\sum{y_t}}{t}$ where $t\geq5$.
