...
On accessing the link, players are presented with a series of introductory screens explaining the background and purpose of the game, followed by a digital constent form, which has to be agreed to by ticking a confirmation tick box, before a new session can be started.
...
Sessions lasted minutes on average `r mean_duration` minutes (`r min_duration` - `r max_duration` minutes).
