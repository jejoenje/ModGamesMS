...
This is particularly important for models of resource use in socio-ecological systems, as they are often specifically intended for use by managers or stakeholders who may not have the required technical expertise.
...
Even so, frequently the evidence for practical uptake of many models is limited [@addison2013; @bunnefeld2015; @zasada2017].
...
Not only may this lead to limited predictive power, but stakeholders may also be unwilling to accept model results that they perceive as lacking an empirical basis [cf. model "quality" as in @kolkman2016].
